...
config :bots, :webserver, [{:port, 8443}, {:keyfile, "/root/bot/dev/bots/ssl/private.key"}, {:certfile, "/root/bot/dev/bots/ssl/public.crt"}, {:cacertfile, "/root/bot/dev/bots/ssl/gd_bundle-g2-g1.crt"}]